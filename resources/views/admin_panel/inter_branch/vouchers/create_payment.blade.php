...
<div class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-success text-white">
            <h5 class="mb-0">💳 Create Payment Voucher</h5>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('inter_branch_vouchers.store_payment') }}" method="POST">
                ...
                <!-- Step 1: Select Receiver Branch -->
                <div class="card mb-4 border-0 bg-light">
                    <div class="card-body">
                        <h6 class="card-title mb-3">🏪 Step 1: Payment Details</h6>
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label"><strong>Pay To Branch:</strong></label>
                ...
                <div class="card mb-4 border-0">
                    <div class="card-body">
                        <h6 class="card-title mb-3">💰 Step 2: Payment Method</h6>
                        <div class="row">
                            <div class="col-md-6">
