...
<head>
    ...
    <style>
        :root {
            ...
            --accent: #b45309; /* Custom Amber/Brown theme for Expense vouchers */
            --accent-light: #fef3c7;
            --text-dark: #0f172a;
            --text-muted: #475569;
            --bg-light: #f8fafc;
    ...
    <div class="page">
        ...
        <header>
            ...
            <div class="voucher-badge-container">
                ...
                <div>
                    <span class="receipt-badge" style="background-color: var(--primary);">EXPENSE VOUCHER</span>
                </div>
            </div>
        </header>
        ...
        <div class="meta-grid">
            ...
            <div class="card">
                ...
                <div class="meta-line">
                    ...
                    <span class="meta-value" style="font-weight: 800; color: var(--accent);">{{ $voucher->evid }}</span>
                </div>
                <div class="meta-line">
        ...
        <div class="details-section">
            <h3 class="section-title">Itemized Expense Breakdowns</h3>
                ...
                <tbody>
                    ...
                    @php
                        ...
                        if (empty($rowNarration)) {
                            $rowNarration = "Expense Voucher — Paid to " . $receiverName;
                        }
                    @endphp
                    <tr>
                        <td>{{ $key + 1 }}</td>
