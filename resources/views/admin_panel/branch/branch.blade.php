                                             ...
                                             @foreach ($branches as $branch)
                                                 <tr>
                                                     ...
                                                     <td class="address">{{ $branch->address }}</td>
                                                         @php
                                                             $emails = '-';
                                                             if (!empty($branch->userhasmany) && count($branch->userhasmany) > 0) {
                                                                 $emails = collect($branch->userhasmany)->pluck('email')->filter()->unique()->implode(', ');
                                                                 if (empty($emails)) $emails = '-';
                                                             }
                                                         @endphp
                                                         <td class="email">{{ $emails }}</td>
